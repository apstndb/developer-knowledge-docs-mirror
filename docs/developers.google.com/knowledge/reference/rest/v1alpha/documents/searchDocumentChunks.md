---
name: documents/developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks
uri: https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks
...
---
  ...
  - [HTTP request](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#body.HTTP_TEMPLATE)
  - [Query parameters](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#body.QUERY_PARAMETERS)
  - [Request body](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#body.request_body)
  - [Response body](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#body.response_body)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#body.SearchDocumentChunksResponse.SCHEMA_REPRESENTATION)
  - [Authorization scopes](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#body.aspect)
  - [Try it\!](https://developers.google.com/knowledge/reference/rest/v1alpha/documents/searchDocumentChunks#try-it)
