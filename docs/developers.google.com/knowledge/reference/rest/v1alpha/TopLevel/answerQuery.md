---
name: documents/developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery
uri: https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery
...
---
  ...
  - [HTTP request](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#body.HTTP_TEMPLATE)
  - [Request body](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#body.request_body)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#body.request_body.SCHEMA_REPRESENTATION)
  - [Response body](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#body.response_body)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#body.AnswerQueryResponse.SCHEMA_REPRESENTATION)
  - [Authorization scopes](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#body.aspect)
  - [Answer](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#Answer)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#Answer.SCHEMA_REPRESENTATION)
  - [AnswerCitation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#AnswerCitation)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#AnswerCitation.SCHEMA_REPRESENTATION)
  - [CitationSource](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#CitationSource)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#CitationSource.SCHEMA_REPRESENTATION)
  - [AnswerReference](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#AnswerReference)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#AnswerReference.SCHEMA_REPRESENTATION)
  - [DocumentReference](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#DocumentReference)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#DocumentReference.SCHEMA_REPRESENTATION)
  - [Try it\!](https://developers.google.com/knowledge/reference/rest/v1alpha/TopLevel/answerQuery#try-it)
