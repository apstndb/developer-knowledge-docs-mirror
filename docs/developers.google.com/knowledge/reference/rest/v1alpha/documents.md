---
name: documents/developers.google.com/knowledge/reference/rest/v1alpha/documents
uri: https://developers.google.com/knowledge/reference/rest/v1alpha/documents
...
---
  ...
  - [Resource: Document](https://developers.google.com/knowledge/reference/rest/v1alpha/documents#Document)
      - [JSON representation](https://developers.google.com/knowledge/reference/rest/v1alpha/documents#Document.SCHEMA_REPRESENTATION)
  - [DocumentView](https://developers.google.com/knowledge/reference/rest/v1alpha/documents#DocumentView)
  - [Methods](https://developers.google.com/knowledge/reference/rest/v1alpha/documents#METHODS_SUMMARY)
